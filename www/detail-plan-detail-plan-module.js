...
module.exports = ".padding {\n  padding-left: 20px;\n  padding-right: 20px; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var DetailPlanPage = /** @class */ (function () {
    function DetailPlanPage(route, router, services, planService, tableService, reportService, alertas, datePipe, toastController) {
        this.route = route;
        this.router = router;
    ...
    DetailPlanPage.prototype.ngOnInit = function () {
        ...
        this.planService.getById(id).subscribe(function (plan) {
            console.log(plan);
            _this.plan = plan;
            _this.filter.id_plan = _this.plan.id;
            _this.filter.id_service = _this.plan.service_id; //la variable filter sirve para colocar por parametros las propiedadesa filtrar
            ...
            _this.planService.findService(_this.plan.service_id).subscribe(function (service) {
                ...
                _this.planService.findPartner(service["partner"]).subscribe(function (partner) {
                    ...
                    _this.filter.id_partner = _this.partner.id;
    ...
    DetailPlanPage.prototype.getChart = function (context, chartType, data, options) {
        return new chart_js__WEBPACK_IMPORTED_MODULE_12__["Chart"](context, {
            data: data,
            options: options,
            type: chartType
        });
    };
    DetailPlanPage.prototype.presentToast = function (text, color) {
    ...
    DetailPlanPage.prototype.list = function (event) {
        var _this = this;
        ...
        if (httpParams['updates'] != null) {
            ...
            this.reportService.getReportInvoices(this.reportService.buildRequestOptionsFinder(this.tableService.sort, 'm', httpParams['updates'], {
                ...
                if (_this.items.length === 0) {
                    ...
                    _this.filter.id_service = -1;
                    var httpParams1 = new _angular_common_http__WEBPACK_IMPORTED_MODULE_8__["HttpParams"]();
                    httpParams1 = _this.filter.getHttpParams(httpParams1);
                    _this.reportService.getReportInvoicesGrap(_this.reportService.buildRequestOptionsFinder(_this.tableService.sort, 'm', httpParams1['updates'], {
    ...
    DetailPlanPage.prototype.generateGrap = function (labels, data1) {
        var data = {
            labels: labels,
            datasets: [{
                    label: '% de Facturas',
    ...
    DetailPlanPage.prototype.loadData = function (event1, event) {
        var _this = this;
        ...
        if (httpParams["updates"] != null) {
            ...
            this.reportService
                .getReportInvoices(this.reportService.buildRequestOptionsFinder(this.tableService.sort, "m", httpParams["updates"], {
                pageIndex: event
                    ? event.pageIndex
    ...
    DetailPlanPage.prototype.toggleInfiniteScroll = function () {
    ...
    DetailPlanPage.prototype.estatus_invoices = function () {
    ...
    DetailPlanPage.prototype.statusData = function () {
    ...
    DetailPlanPage.prototype.read = function (item) {
    ...
    ], DetailPlanPage.prototype, "infiniteScroll", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
