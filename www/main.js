...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.addOptionInHeader = function (key, value) {
...
/***/ "./src/app/providers/utils/BaseModel.ts":
/*!**********************************************!*\
  !*** ./src/app/providers/utils/BaseModel.ts ***!
  \**********************************************/
...
/***/ "./src/app/providers/utils/accessTokenRequest.ts":
/*!*******************************************************!*\
  !*** ./src/app/providers/utils/accessTokenRequest.ts ***!
  \*******************************************************/
/*! exports provided: AccessTokenRequest */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AccessTokenRequest", function() { return AccessTokenRequest; });
...
/***/ "./src/app/providers/utils/accessTokenResponse.ts":
/*!********************************************************!*\
  !*** ./src/app/providers/utils/accessTokenResponse.ts ***!
  \********************************************************/
/*! exports provided: AccessTokenResponse */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AccessTokenResponse", function() { return AccessTokenResponse; });
...
/***/ "./src/app/providers/utils/alertas.ts":
/*!********************************************!*\
  !*** ./src/app/providers/utils/alertas.ts ***!
  \********************************************/
...
var AlertService = /** @class */ (function () {
    function AlertService(loadingController) {
        this.loadingController = loadingController;
        this.isLoading = false;
    }
    AlertService.prototype.showAutoHideLoader = function () {
...
/***/ "./src/app/providers/utils/authorizationRequest.ts":
/*!*********************************************************!*\
  !*** ./src/app/providers/utils/authorizationRequest.ts ***!
  \*********************************************************/
/*! exports provided: AuthorizationRequest */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AuthorizationRequest", function() { return AuthorizationRequest; });
...
var BaseService = /** @class */ (function () {
    ...
    BaseService.createAuthorizationHeader = function () {
        var headers = new _angular_http__WEBPACK_IMPORTED_MODULE_0__["Headers"]();
        headers.append('Authorization', sessionStorage.getItem('token'));
        return headers;
    }; //  sessionStorage.getItem('token')
    BaseService.extractData = function (res) {
        var body = res.json();
        return body.result;
    };
    BaseService.extractDataFull = function (res) {
        return res.json();
    };
    BaseService.extractHeaders = function (res) {
        return res.headers;
    };
    BaseService.handleResponse = function (res) {
        return res.ok;
    };
    BaseService.handleError = function (error) {
        var errMsg;
        if (error instanceof _angular_http__WEBPACK_IMPORTED_MODULE_0__["Response"]) {
            if (error.status === 403) {
                return rxjs__WEBPACK_IMPORTED_MODULE_1__["Observable"].throw('No posee permisos suficientes para esta accion, contacte con el administrador');
            }
            var body = error.json() || '';
    ...
    BaseService.handleErrorCreate = function (error) {
        if (error instanceof _angular_http__WEBPACK_IMPORTED_MODULE_0__["Response"]) {
            if (error.status === 400) {
                return rxjs__WEBPACK_IMPORTED_MODULE_1__["Observable"].throw('Corriga los parámetros inválidos e intente nuevamente');
            }
            if (error.status === 409) {
                return rxjs__WEBPACK_IMPORTED_MODULE_1__["Observable"].throw('Corriga los parámetros o dependencias inválidas e intente nuevamente');
            }
        }
        return rxjs__WEBPACK_IMPORTED_MODULE_1__["Observable"].throw('Consulte con el administrador del sistema');
    };
    BaseService.handleErrorUpdate = function (error) {
        if (error instanceof _angular_http__WEBPACK_IMPORTED_MODULE_0__["Response"]) {
            if (error.status === 400) {
                return rxjs__WEBPACK_IMPORTED_MODULE_1__["Observable"].throw('Corriga los parámetros inválidos e intente nuevamente');
            }
            if (error.status === 401) {
                return rxjs__WEBPACK_IMPORTED_MODULE_1__["Observable"].throw('Su contraseña actual es incorrecta');
            }
            if (error.status === 404) {
                return rxjs__WEBPACK_IMPORTED_MODULE_1__["Observable"].throw('Registro inexistente');
            }
            if (error.status === 409) {
                return rxjs__WEBPACK_IMPORTED_MODULE_1__["Observable"].throw('Corriga los parámetros o dependencias inválidas e intente nuevamente');
            }
    ...
    BaseService.handleErrorDelete = function (error) {
        if (error instanceof _angular_http__WEBPACK_IMPORTED_MODULE_0__["Response"]) {
            if (error.status === 409) {
                return rxjs__WEBPACK_IMPORTED_MODULE_1__["Observable"].throw('Elimine las dependencias e intente nuevamente');
            }
        }
        return rxjs__WEBPACK_IMPORTED_MODULE_1__["Observable"].throw('Consulte con el administrador del sistema');
    };
