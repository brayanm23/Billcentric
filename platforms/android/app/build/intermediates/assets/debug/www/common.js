...
/* harmony import */ var _service_services_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../service/services.service */ "./src/app/service/services.service.ts");
/* harmony import */ var _partner_partner_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../partner/partner.service */ "./src/app/partner/partner.service.ts");
...
var PlanService = /** @class */ (function (_super) {
    ...
    function PlanService(http, serviceS, partnerService) {
    ...
    PlanService.prototype.getById = function (id) {
        return this.http.get(PlanService_1.BASE_URL + '/' + id, { headers: _services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"].createAuthorizationHeader() })
            .map(_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"].extractData)
            .catch(_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"].handleError);
    };
    PlanService.prototype.findService = function (id) {
        return this.serviceS.getById(id);
    };
    PlanService.prototype.findPartner = function (id) {
    ...
    PlanService = PlanService_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_http__WEBPACK_IMPORTED_MODULE_3__["Http"],
            _service_services_service__WEBPACK_IMPORTED_MODULE_4__["ServicesService"],
            _partner_partner_service__WEBPACK_IMPORTED_MODULE_5__["PartnerService"]])
    ], PlanService);
    return PlanService;
